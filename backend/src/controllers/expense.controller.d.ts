...
export declare function getSummary(req: AuthRequest, res: Response): Promise<void>;
export declare function getUserSummary(req: AuthRequest, res: Response): Promise<void>;
